...
CREATE TABLE `tbl_logistics`  (
  ...
  INDEX `logistics_orderid`(`order_id` ASC) USING BTREE,
  CONSTRAINT `logistics_user_id` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `logistics_orderid` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
